...
export const EmployeesPage = () => {
  ...
  const { employees, employeesLoading, employeesError, departments, designations, addEmployee, updateEmployeeStatus, resendInvitation, verifyEmployeeProfile } = useHR();
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {employeesLoading ? (
                ...
                <tr>
                  <td colSpan="6" className="py-12 text-center text-rose-600 font-medium">
                    <div className="flex flex-col items-center justify-center gap-1">
                      <span className="font-extrabold">Failed to load employees from database</span>
                      <span className="text-xs text-rose-500">{employeesError}</span>
                    </div>
                  </td>
                </tr>
