...
export function LeaveAttentionCard() {
  const items = [
    { icon: Clock, text: '3 requests pending over 48 hours', color: 'text-rose-500', bg: 'bg-rose-100' },
    { icon: FileWarning, text: '2 requests missing documents', color: 'text-amber-500', bg: 'bg-amber-100' },
    { icon: AlertCircle, text: '2 employees awaiting clarification', color: 'text-blue-500', bg: 'bg-blue-100' },
  ];
