      ...
      <Card className="w-full max-w-md shadow-xl border-slate-100 rounded-2xl">
        <CardHeader className="space-y-2 text-center pt-8 pb-6">
          ...
          <CardDescription className="text-slate-500">
            Sign up to get started with Saath HR
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSignup}>
          ...
          <CardFooter className="flex flex-col space-y-4 px-8 pb-8 pt-4">
            <Button type="submit" className="w-full h-12 rounded-xl text-base bg-blue-600 hover:bg-blue-700 font-semibold" disabled={isLoading || !email || !password || !name}>
